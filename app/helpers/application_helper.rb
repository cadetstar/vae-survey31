module ApplicationHelper
  ...
  def cif_restrictor
    raw %w(Unsent Flagged Sent Captured Completed All).reject{|c| session[:cifs][:status] == c.downcase}.collect{|c| link_to c, cifs_path(:status => c.downcase)}.join(" &middot; ")
  end
  ...
  def token_helper
    raw <<-OUTPUT
    <div class='tokens'>
      <div class='header_div'><a href='#' class="header">View Token Help.</a></div>
      <div class='body_div' style='display: none;'>
        <a href='#' class='body'>Collapse Token Help.</a><br />
